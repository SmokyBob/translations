...
const itClient = const <String, String> {
  ...
  mDeleteBrowserCacheEtc:
    'Puoi provare a <a href="https://www.lifewire.com/how-to-clear-cache-2617980" target="_blank">pulire i file della cache del browser</a>, '
    'e ricaricare la pagina.',
  mCtrl: "Ctrl",
  mShift: "Shift",
  mAlt: "Alt",
  ...
  mCantMoveExternalTeamRootTask: "Non puoi spostare attività Principali a Gruppi Esterni.",
  ...
  "UDS$udtComplete": "Completeti [=task]",
  "UDP$udtComplete": "Completeti [=task] e altri",
  "UDS$udtArchive": "Peekaboo [=task]",
  "UDP$udtArchive": "Peekaboo [=task] e altri",
  "UDS$udtReopen": "Riaperti [=task]",
  "UDP$udtReopen": "Riaperti [=task] e altri",
  "UDS$udtState": "Modificato lo stato di [=task]",
  "UDP$udtState": "Modificato lo stato di [=task] e altri",
  "UDS$udtMove": "Spostato [=task]",
  "UDP$udtMove": "Spostato [=task] e altri",
  "UDS$udtRemove": "Eliminato [=task]",
  "UDP$udtRemove": "Eliminato [=task] e altri",
  "UDS$udtDup": "Duplicato [=task]",
  "UDP$udtDup": "Duplicato [=task] e altri",
  "UDS$udtAssign": "Assegnato [=task] a [=value]",
  "UDP$udtAssign": "Assegnato [=task] a [=value] e altri",
  "UDSR$udtAssign": "Disassegnato [=value] da [=task]",
  "UDPR$udtAssign": "Disassegnato [=value] da [=task] e altri",
  "UDSC$udtAssign": "Disassegnati tutti da [=task]",
  "UDPC$udtAssign": "Disassegnati tutti da [=task] e altri",
  "UDS$udtDue": "Setta data scadenza [=value:due] a [=task]",
  "UDP$udtDue": "Setta data scadenza [=value:due] a [=task] e altri",
  "UDSR$udtDue": "Rimossa data scadenza [=value:due] da [=task]",
  "UDPR$udtDue": "Rimossa data scadenza [=value:due] da [=task] e altri",
  "UDS$udtTag": "Aggiunta etichetta [=value] a [=task]",
  "UDP$udtTag": "Aggiunta etichetta [=value] a [=task] e altri",
  "UDSR$udtTag": "Rimossa etichetta [=value] da [=task]",
  "UDPR$udtTag": "Rimossa etichetta [=value] da [=task] e altri",
  "UDSC$udtTag": "Rimosse etichette da [=task]",
  "UDPC$udtTag": "Rimosse etichette da [=task] e altri",
  "UDS$udtPriority": "Prioritizzato [=task] con [=value]",
  "UDP$udtPriority": "Prioritizzato [=task] e altri con [=value]",
  "UDS$udtTitle": "Rinominato [=value] a [=task]",
  "UDP$udtTitle": "Rinominato [=value] e altri a[=task]",
  "UDS$udtDesc": "Modificata descrizione di [=task]",
  "UDP$udtDesc": "Modificate descrizioni di [=task] e altri",
